...
ageList=['(0-2)', '(4-6)', '(8-12)', '(15-20)', '(21-32)', '(33-43)', '(45-53)', '(60-100)']
...
def main():
    ...
    # Set window title
    window.title('Mask Detection with Age and Gender')
    ...
    title_label = Label(window, text="Face Mask Detection with Age and Gender Classification", font=("Arial", 24), bg="white")
    title_label.pack(side=TOP, pady=20)

    button_live_stream = Button(window,
                                text="Live Stream",
                                command=main_func)
    button_live_stream.pack(side=TOP, pady=10)

    button_exit = Button(window,
                         text="Exit",
                         command=lambda: exit(window))
    button_exit.pack(side=TOP, pady=10)
